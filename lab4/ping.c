...
void *ping(void /* *sock */) {
    ...
    /*craft_ip(dsthwaddr.sll_ifindex, &dstaddr, buf, <#(in_addr_t)src_ip#>, <#(in_addr_t)dst_ip#>, <#(unsigned char[6])src_mac#>, <#(unsigned char[6])dst_mac#>, <#(void*)data#>, <#(size_t)data_len#>)*/
